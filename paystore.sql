...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2019 at 03:31 PM
...
('karim aly', 20, 'karim@gm.com', ':98765432', 37, NULL, NULL, NULL, NULL, NULL, '5cab3cac10deb1.76714685.jpg'),
('asd asd', 55, 'aaa@u.com', '987654321', 38, NULL, NULL, NULL, NULL, NULL, 'mem.png'),
('Amr Nabil', 22, 'amr@gmail.com', '123456789', 39, NULL, NULL, NULL, NULL, NULL, 'mem.png');
...
(32, 'tap', 'Tablet', 'brandx', 45, 4, 'tab7.jpg', 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alter'),
(33, 'tv', 'Laptop', 'jcnjk', 4454, 22, '5c73c26fb93f51.54637876.jpg', NULL),
(35, 'heloolap', 'Laptop', 'hp', 500, 0, 'Dell-Inspiron.jpg', NULL),
(48, 'se', 'Tablet', 'xd', 54, 55, '5b4f50c40f0690.75597197.jpg', NULL),
(49, 'asas', 'Laptop', 'sdsd', 23, 2, '5cab68dd12b145.07897616.jpg', NULL);
...
--
ALTER TABLE `cart`
  MODIFY `count` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `love`
  MODIFY `n_love` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
