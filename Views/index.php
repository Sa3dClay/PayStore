            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="title" id="shop">Latest Products</h2>
                    </div>
                </div>
                <!-- section title -->
                
                <?php for ($i=sizeof($arr)-1, $j=0; $i>=0 && $j<$maxShow; $i--, $j++) { ?>
