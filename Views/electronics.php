...
<head>
    ...
    <title><?php echo "Electronics"; ?></title>
...
<body>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <h2 class="myh text-center" id="shop">Electronics</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="./img/elec5.jpg" alt="electronics">
                        <div class="banner-caption">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="./img/apple_iphone.jpg" alt="">
                        <div class="banner-caption">
                            <h2 class="white-color">NEW<br>COLLECTION</h2>
                            <button class="primary-btn">Shop Now</button>
                        </div>
